...
export default function Home() {
  return (
    <div className="overflow-hidden">
      ...
      {/* ─── Plans ─── */}
      <section id="plans" className="px-4 py-20 sm:py-28">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              ...
              <div key={plan.name} className={`relative rounded-2xl border p-6 sm:p-8 card-hover ${plan.popular ? "border-primary/40 bg-primary/[0.03] glow-green" : "border-border bg-surface-elevated"}`}>
                {plan.popular && (
            ...
            <div className="rounded-2xl border border-border bg-gradient-to-br from-primary/[0.03] to-transparent p-6 sm:p-8">
              ...
              <div className="mt-6 grid grid-cols-3 gap-3">
                {[
                  ...
                  { value: "154K", label: "Trades" },
                  { value: "+34%", label: "ROI" },
                ].map((s) => (
                  <div key={s.label} className="rounded-xl bg-surface border border-border p-3 text-center">
